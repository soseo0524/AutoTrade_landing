                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="grid grid-cols-[1fr_140px] items-center gap-4">
                                    <span className="text-2xl font-bold text-blue-400 truncate">{part.price}</span>
                                    <button className="flex items-center justify-center gap-2 w-full px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-sm font-medium transition-colors">
